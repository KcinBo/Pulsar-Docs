...
PULSAR is intended to be treasury-backed, not pegged to one dollar or any other fixed market price.

A peg targets a specific exchange rate. Backing means identifiable assets sit in the protocol treasury. Backing does **not** guarantee that PULSAR will trade at or above any accounting value, and it does not create an automatic right to redeem PULSAR for treasury assets unless a future contract explicitly provides one.

## Built for PulseChain apes, explained for everyone

The protocol can be degen without being deliberately confusing. The short version is:

1. The treasury acquires approved assets.
2. Those assets are managed under a public policy.
3. PULSAR holders may stake into QUASAR.
4. Rewards can come from emissions, treasury earnings, or both—but the docs and dashboard should identify the source.
5. The goal is to grow productive protocol-owned capital over time.

> PULSAR is not a stablecoin, a bank deposit, or a guaranteed investment. Crypto assets, treasury strategies, smart contracts, bridges, and market liquidity can all fail.
